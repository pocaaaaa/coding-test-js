...
const solution = (a, b, n) => {
    let changeCoke = Math.floor(n / a) * b; // 변경할 콜라
    let tempCoke = n % a;                   // 남은 콜라
    let cokeCount = 0;
    
    while(changeCoke) {
        cokeCount += changeCoke;
        changeCoke = changeCoke + tempCoke;
        tempCoke = changeCoke % a;
        changeCoke = (Math.floor((changeCoke) / a) * b) 
    }
